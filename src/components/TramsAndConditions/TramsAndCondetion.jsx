...
const TramsAndConditions = () => {
  ...
  return (
    <div>
      <h3 className="mb-4 capatilize">Terms and Conditions</h3>
      <p>
        What is Lorem Ipsum? Lorem Ipsum is simply dummy text of the printing
        and typesetting industry. Lorem Ipsum has been the industrys standard
        dummy text ever since the 1500s, when an unknown printer took a galley
        of and scrambled it to make a specimen book. It has survived not only
        ...
        publishing packages and web page editors now use Lorem their model text,
        ...
        it come from? Contrary to popular belief, Lorem Ipsum is not simply
      ...
      <Button className="btn btn-promary" onClick={() => navigate(-1)}>
        Go back
      </Button>
    </div>
  );
